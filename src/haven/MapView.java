...
public class MapView extends PView implements DTarget, Console.Directory {
	...
	private final Color NVAMBIENTCOL = new Color(200, 200, 200);
	private final Color NVDIFFUSECOL = new Color(200, 200, 200);
	private final Color NVSPECCOC = new Color(255, 255, 255);
	...
	private void amblight() {
		synchronized(glob) {
			if(glob.lightamb != null) {
				amblight = new DirLight(NVAMBIENTCOL, NVDIFFUSECOL, NVSPECCOC, Coord3f.o.sadd((float)glob.lightelev, (float)glob.lightang, 1f));
				amblight.prio(100);
			} else {
				amblight = null;
			}
